...
//{
//   if(pixel(0) < 0 || pixel(0) > G2LTexConfig::get().IMAGE_WIDTH - 1 ||
//           pixel(1) < 0 || pixel(1) > G2LTexConfig::get().IMAGE_HEIGHT - 1)
//    {
//        std::cout<<"x:"<<pixel(0)<<" y:"<<pixel(1)<<std::endl;
//        math::Vec3f mcolor(0.0f, 0.0f, 0.0f);
//
//        return mcolor;
//    }
